...
const thecontactpage = document.getElementById("contact-page");
...
thesubmitbutton.addEventListener("click", function (event) {
  event.preventDefault();
  thecontactpage.innerHTML = "<p>Thank you for your message!</p>";
  thecontactpage.style.fontSize = "24px";
});
