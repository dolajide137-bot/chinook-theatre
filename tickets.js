...
let theratepernight = 25;
let thenightselected = 0;

const thenightlist = document.querySelectorAll(".day-selector li");
const thegeneralbutton = document.getElementById("general");
const thevipbutton = document.getElementById("vip");
const theclearbutton = document.getElementById("clear-button");
const thetotalcost = document.getElementById("total-cost");
...
function calculateTotal() {
  thetotalcost.innerHTML = thenightselected * theratepernight;
}
...
thenightlist.forEach(function (night) {
  night.addEventListener("click", function () {
    if (night.classList.contains("clicked")) {
      night.classList.remove("clicked");
      thenightselected = thenightselected - 1;
    } else {
...
thegeneralbutton.addEventListener("click", function () {
  theratepernight = 25;
  thegeneralbutton.classList.add("clicked");
  thevipbutton.classList.remove("clicked");
  calculateTotal();
});

thevipbutton.addEventListener.addEventListener("clicked", function () {
  theratepernight = 50;
  thevipbutton.classList.add("clicked");
  thegeneralbutton.classList.remove("clicked");
  calculateTotal();
});
